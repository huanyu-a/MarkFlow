...
> 完整 64 套以应用内主题面板为准，按「极简 / 商务 / 科技 / 文艺编辑 / 复古人文 / 温暖 / 高亮」七大分组管理。下表为常用 20 套代表（名称与色值和应用内严格一致）。

| 主题 | 分组 | accent | dark | 适合内容 |
|------|------|--------|------|----------|
| 默认（API 缺省） | 极简 | #27ae60 | #1e8449 | 健康、养生、自然、通用 |
| Notion | 极简 | #000000 | #1a1a1a | 摄影集、极简主义、正式公告 |
| Stripe | 极简 | #635bff | #4f46e5 | 互联网产品、SaaS、科技金融 |
| 字节跳动 | 商务 | #3350ff | #1e3afa | 互联网、产品发布、品牌内容 |
| Goldman | 商务 | #1e3a5f | #0f2744 | 财经、商务、职场、深度分析 |
| 商务红 | 商务 | #e74c3c | #c0392b | 节日、促销、餐饮 |
| 科技蓝 | 科技 | #0984e3 | #0769b5 | 科技、数码、互联网、AI |
| OpenAI | 科技 | #10a37f | #0d8c6d | AI、技术教程、工具评测 |
| 正青 | 科技 | #0d9488 | #0f766e | 医疗健康、环保、设计 |
| 知乎蓝 | 文艺编辑 | #0066ff | #0052cc | 知识科普、观点文、教育 |
| 微信原生 | 文艺编辑 | #07c160 | #06ad56 | 公众号原生观感、平台公告 |
| Markdown | 文艺编辑 | #555555 | #333333 | 技术文档、通知、极简 |
| 优雅金 | 复古人文 | #b8860b | #8b6508 | 高端品牌、颁奖、周年庆 |
| 酒红 | 复古人文 | #722f37 | #5a252c | 历史厚重、文化、高端餐饮 |
| 复古纸 | 复古人文 | #a8763e | #865c2b | 历史、人文、书评、茶文化 |
| 珊瑚粉 | 温暖 | #ff6b6b | #e05555 | 美食、生活分享、旅行 |
| 活力橙 | 温暖 | #f39c12 | #e67e22 | 美食、亲子、生活方式 |
| 玫红 | 温暖 | #e84393 | #d63384 | 情感、美妆、女性向 |
| 荧光绿 | 高亮 | #22c55e | #16a34a | 活动、游戏、潮流内容（高饱和亮色，冲击力强） |
| 宝石蓝 | 高亮 | #3b82f6 | #2563eb | 数码评测、运动、品牌活动（高饱和亮色，冲击力强） |

> 旧名对照：靛蓝→长春花蓝、薄荷绿→翡翠绿、优雅紫→酒红、橄榄手记→墨黑手记、渐变橙→琥珀橙、午夜蓝→宝石蓝、暗夜紫→亮紫、霓虹绿→荧光绿、赛博粉→荧光粉、GitHub Dark→GitHub 蓝、琥珀暗→琥珀亮、暗夜红→正红、暖阳黄→暖橙。「高亮」分组为高饱和亮色，输出仍为白底、并非暗色渲染。
