...
export const LAYOUT_EXAMPLES: Record<string, string> = {
  ...
  'stat-row': '[{"label":"覆盖模块数","value":"61 个","trend":"+18","color":"accent"},{"label":"支持主题","value":"60 套","trend":"+8 套","color":"default"},{"label":"平均导出耗时","value":"0.8s","trend":"-40%","color":"accent"},{"label":"月活创作者","value":"12K+","trend":"+23%","color":"default"}]',
  ...
  'comparison-table': '{"left":{"title":"传统手工排版","items":["上手 2-4 周","依赖设计师手感","需逐篇调整移动端"]},"right":{"title":"MarkFlow 模块化","items":["上手 10 分钟","60 套主题自动保证","所有模块内置适配"]}}',
  changelog: '{"version":"v2.5.0","date":"2026-07-31","added":["新增 4 套主题：摸鱼绿、石墨极简、留白禅意、橄榄手记","公众号草稿箱发布配置与命令生成","组件库按渲染样式自动去重"],"changed":["主题总数为 60 套","组件库分类映射完善"],"fixed":["组件库分类正确映射到 11 个功能分组"]}',
}
