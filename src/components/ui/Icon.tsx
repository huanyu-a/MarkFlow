...
// AI / 人工智能（星星 + 电路纹理）
export function AiStar({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
// 侧边栏 / 布局（左右分栏图标）
export function SidebarIcon({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
...
// 文件列表 / 示例（多页文档图标）
export function FileList({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
...
// 发送 / 纸飞机
export function Send({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
// Undo2 / 撤销
export function Undo2({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
// Redo2 / 重做
export function Redo2({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
// Columns2 / 并排对比
export function Columns2({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
...
// Maximize2 / 全屏
export function Maximize2({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M15 3h6v6" />
      <path d="M9 21H3v-6" />
...
// Minimize2 / 退出全屏
export function Minimize2({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M4 14h6v6" />
      <path d="M20 10h-6V4" />
...
// Grid / 组件库
export function Grid({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
