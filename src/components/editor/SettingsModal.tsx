...
import { HardDrive, Cloud, Package, AlertTriangle, Shield, AiStar } from '@/components/ui/Icon'
            ...
            <>
              <div className="rounded-lg bg-slate-50 p-4 border border-slate-100 flex flex-col gap-3">
                <div className="text-[13px] leading-relaxed text-slate-500 mb-1">
                  ...
                  <p>支持 DeepSeek / Moonshot / 通义千问等 OpenAI 兼容协议。配置后可在 AI 排版面板中直接调用 AI 增强排版。</p>
                </div>
                <div>
                ...
                <p className="text-[11px] text-slate-400">配置会自动保存到本地。常用地址：DeepSeek: https://api.deepseek.com | Moonshot: https://api.moonshot.cn</p>
              </div>
            </>
          ) : (
            <>
