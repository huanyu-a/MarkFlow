...
export const Title_DA02 = {
  ...
  attrs: [
    ...
    example: `<title type="DA02" label="UPDATE" subtitle="v2.0 新增段落标题、步骤流程、时间线、对比卡片、提示框等 12 个高级排版组件，主题系统扩展至 60 套专业配色方案。" chips="新组件|60套主题|性能优化|公众号适配">MarkFlow v2.0 版本更新说明</title>`,
