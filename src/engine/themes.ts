...
export const THEME_PROFILES: ThemeProfile[] = [
  ...
  { id: 'vercel', name: 'Vercel', category: 'minimal', accent: '#000000', dark: '#111111', headingScale: 1.15, headingWeight: 800, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  ...
  { id: 'claude', name: 'Claude', category: 'tech', accent: '#cc785c', dark: '#a8604a', headingScale: 1, headingWeight: 700, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border-bg' },
  ...
  { id: 'tailwind', name: 'Tailwind', category: 'tech', accent: '#06b6d4', dark: '#0e7490', headingScale: 1, headingWeight: 600, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'sharp', quoteStyle: 'border' },

  // ── 文艺编辑 (8) ──
  { id: 'elegant-gold', name: '优雅金', category: 'editorial', accent: '#b8860b', dark: '#8b6508', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '16', radiusLevel: 'round', quoteStyle: 'border-bg' },
  { id: 'elegant-green', name: '优雅绿', category: 'editorial', accent: '#556b2f', dark: '#3d4f1f', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '16', radiusLevel: 'round', quoteStyle: 'border-bg' },
  { id: 'elegant-purple', name: '优雅紫', category: 'editorial', accent: '#722f37', dark: '#5a252c', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '16', radiusLevel: 'round', quoteStyle: 'border-bg' },
  ...
  { id: 'warm-yellow', name: '暖阳黄', category: 'warm', accent: '#e67e22', dark: '#d35400', headingScale: 1.15, headingWeight: 700, headingColor: 'textPrimary', bodySize: '16', radiusLevel: 'round', quoteStyle: 'bg' },
  ...
  { id: 'vercel-gradient', name: '渐变橙', category: 'warm', accent: '#f59e0b', dark: '#d97706', headingScale: 1.3, headingWeight: 800, headingColor: 'textPrimary', bodySize: '16', radiusLevel: 'round', quoteStyle: 'bg' },
  ...
  { id: 'matcha', name: '抹茶', category: 'warm', accent: '#80b918', dark: '#6a9b14', headingScale: 1, headingWeight: 700, headingColor: 'textPrimary', bodySize: '16', radiusLevel: 'round', quoteStyle: 'bg' },
  ...
  // ── 暗色 (8) ──
  { id: 'midnight', name: '午夜蓝', category: 'dark', accent: '#3b82f6', dark: '#2563eb', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  { id: 'dark-purple', name: '暗夜紫', category: 'dark', accent: '#8b5cf6', dark: '#7c3aed', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  { id: 'neon-green', name: '霓虹绿', category: 'dark', accent: '#22c55e', dark: '#16a34a', headingScale: 1.15, headingWeight: 800, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  { id: 'cyber-pink', name: '赛博粉', category: 'dark', accent: '#ec4899', dark: '#db2777', headingScale: 1.15, headingWeight: 800, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  { id: 'github-dark', name: 'GitHub Dark', category: 'dark', accent: '#58a6ff', dark: '#1f6feb', headingScale: 1, headingWeight: 600, headingColor: 'accent', bodySize: '15', radiusLevel: 'sharp', quoteStyle: 'border' },
  { id: 'discord', name: 'Discord', category: 'dark', accent: '#5865f2', dark: '#4752c4', headingScale: 1, headingWeight: 700, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'bg' },
  { id: 'amber-dark', name: '琥珀暗', category: 'dark', accent: '#f59e0b', dark: '#b45309', headingScale: 1.15, headingWeight: 800, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  { id: 'red-dark', name: '暗夜红', category: 'dark', accent: '#ef4444', dark: '#dc2626', headingScale: 1.15, headingWeight: 800, headingColor: 'accent', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  ...
  { id: 'graphite-minimal', name: '石墨极简', category: 'minimal', accent: '#52525B', dark: '#3f3f46', headingScale: 1, headingWeight: 600, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'sharp', quoteStyle: 'border' },
  // 留白禅意 #4A5D52 (对应 theme-zen-whitespace)
  { id: 'zen-whitespace', name: '留白禅意', category: 'minimal', accent: '#4A5D52', dark: '#3b4a42', headingScale: 1, headingWeight: 600, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  // 摸鱼票据 #059669 - 与摸鱼绿同色，去重不新增
  // 橄榄手记 #1e1f23 (对应 theme-olive-journal)
  { id: 'olive-journal', name: '橄榄手记', category: 'editorial', accent: '#1e1f23', dark: '#17181b', headingScale: 1.15, headingWeight: 700, headingColor: 'accent', bodySize: '16', radiusLevel: 'default', quoteStyle: 'border' },
  // 锤子风格 #B3593B - 跳过：源仓库中为第 7 套主题（theme-hammer），与现有 cocacola(#dc2626) 风格定位重叠且暖砖红配色可用 cocacola 替代

  // ── 原「配色」Tab 独有色并入（8 套，排版轴取中性缺省值）──
  ...
  { id: 'indigo', name: '靛蓝', category: 'business', accent: '#667eea', dark: '#536DFE', headingScale: 1, headingWeight: 700, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
  ...
  { id: 'mint-green', name: '薄荷绿', category: 'minimal', accent: '#00b894', dark: '#00a381', headingScale: 1, headingWeight: 700, headingColor: 'textPrimary', bodySize: '15', radiusLevel: 'default', quoteStyle: 'border' },
